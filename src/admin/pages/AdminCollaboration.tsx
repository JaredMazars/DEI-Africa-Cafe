      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-sm border">
          <div className="inline-flex p-3 rounded-lg bg-[#1A1F5E]/10 mb-3">
            <Briefcase className="w-6 h-6 text-[#0072CE]" />
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border">
          <div className="inline-flex p-3 rounded-lg bg-[#1A1F5E]/10 mb-3">
            <UsersIcon className="w-6 h-6 text-[#0072CE]" />
          </div>
          ...
          <div className="flex gap-4">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${
                activeTab === 'opportunities' ? 'bg-[#1A1F5E]/10 text-[#1A1F5E]' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${
                activeTab === 'groups' ? 'bg-[#1A1F5E]/10 text-[#1A1F5E]' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded text-xs font-bold ${
                          ...
                          opp.status === 'in progress' ? 'bg-[#1A1F5E]/10 text-[#1A1F5E]' :
          ...
          <div className="bg-white rounded-2xl p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={oppForm.title} onChange={(e) => setOppForm({ ...oppForm, title: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Industry *</label>
                  <input type="text" value={oppForm.industry} onChange={(e) => setOppForm({ ...oppForm, industry: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Sector</label>
                  <input type="text" value={oppForm.sector} onChange={(e) => setOppForm({ ...oppForm, sector: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Status</label>
                  <select value={oppForm.status} onChange={(e) => setOppForm({ ...oppForm, status: e.target.value as any })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20">
                ...
                <div>
                  ...
                  <select value={oppForm.priority} onChange={(e) => setOppForm({ ...oppForm, priority: e.target.value as any })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20">
                ...
                <div>
                  ...
                  <input type="date" value={oppForm.deadline} onChange={(e) => setOppForm({ ...oppForm, deadline: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Budget Range</label>
                <input type="text" value={oppForm.budgetRange} onChange={(e) => setOppForm({ ...oppForm, budgetRange: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" placeholder="$500K - $1M" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Description</label>
                <textarea value={oppForm.description} onChange={(e) => setOppForm({ ...oppForm, description: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" rows={3} />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Contact Person</label>
                  <input type="text" value={oppForm.contactPerson} onChange={(e) => setOppForm({ ...oppForm, contactPerson: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Contact Image URL</label>
                  <input type="url" value={oppForm.contactImage} onChange={(e) => setOppForm({ ...oppForm, contactImage: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Regions (comma-separated)</label>
                <input type="text" value={oppForm.regions} onChange={(e) => setOppForm({ ...oppForm, regions: e.target.value })} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A1F5E]/20" placeholder="Nigeria, Ghana, Kenya" />
              </div>
              <div className="flex gap-4 mt-6">
                ...
                <button onClick={handleOppSubmit} className="flex-1 bg-gradient-to-r from-[#0072CE] to-[#1A1F5E] text-white py-3 rounded-lg font-bold"><Save className="w-5 h-5 inline mr-2" />{editingId ? 'Update' : 'Add'}</button>
              </div>
            </div>
          </div>
        </div>
