            ...
            {adminAnalytics.userMetrics.usersByCountry.slice(0, 5).map((country, index) => (
              <div key={country.country} className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className={`w-3 h-3 rounded-full ${index === 0 ? 'bg-[#0072CE]' : index === 1 ? 'bg-green-600' : index === 2 ? 'bg-yellow-600' : index === 3 ? 'bg-[#0072CE]' : 'bg-gray-600'}`}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-[#0072CE] to-[#1A1F5E] bg-clip-text text-transparent">
                  DEI Cafe
                </h1>
