      ...
      <div className="w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white -2xl shadow-2xl p-8 border border-[#E5E7EB]">
            ...
            {error && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 -xl flex items-center space-x-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 -xl focus:ring-2 focus:ring-blue-500 focus:border-[#1A1F5E] transition-all duration-200"
                    required
                  />
                </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-6 bg-[#1A1F5E] text-white font-semibold -xl shadow-lg hover:opacity-90 transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:transform-none flex items-center justify-center space-x-2"
              >
                {isLoading ? (
