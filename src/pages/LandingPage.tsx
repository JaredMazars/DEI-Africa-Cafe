        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                to="/register"
                className="bg-[#0072CE] hover:bg-[#1A1F5E] text-white px-4 py-2 -lg font-medium transition-colors"
              >
                Get Started
              </Link>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="bg-[#0072CE] hover:bg-[#1A1F5E] text-white px-8 py-4 -xl font-semibold text-lg transition-colors flex items-center justify-center space-x-2"
            >
            ...
            <Link
              to="/login"
              className="border border-[#0072CE] text-[#0072CE] hover:bg-[#1A1F5E]/5 px-8 py-4 -xl font-semibold text-lg transition-colors"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white -2xl shadow-lg">
